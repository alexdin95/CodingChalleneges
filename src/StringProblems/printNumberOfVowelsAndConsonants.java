...
public class printNumberOfVowelsAndConsonants {
    public static void findNumberOfVowelsAndConsonants(String input) {
        ...
        for (char c : inputCharArray) {
            if (vowels.indexOf(c) != -1) {
                // metoda indexOf imi spune la ce index se gaseste acel character in string-ul meu vowels
                // -1 apare daca nu se gaseste, deci basically daca returneaza orice inafara de -1 atunci este vowel
                vowelsCount++;
            } else if (c != ' ') {
                consonantCount++;
            }
